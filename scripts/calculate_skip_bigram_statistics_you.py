...
def main(argv):
	...
	print "%0.3f & %0.3f & %0.3f & %0.3f \\\\ \\hline" % (float(total_pro_recall)/pro_lines, float(total_pro_precision)/pro_lines, float(total_recall)/lines, float(total_precision)/lines)
