...
def do_main(argv):
    if len(argv) < 4:
	print "usage: python to_actual_label_test.py --en-file <file> --en-sent-file <file> --zh-file <file> --zh-sent-file <file> --zh-pos-file <file> --bow --f-count --s-count --zh-label --pos-tags --verbs --pronouns"
	return
    parser = OptionParser()
